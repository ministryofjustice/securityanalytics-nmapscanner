module "open_ports_distro" {
  ...
  object_template  = "${path.module}/visualisations/open_ports/open_ports_distro.vis.json"

  object_substitutions = {
    search_id = module.open_ports_search.object_id
  }

  object_type  = "visualization"
  object_title = "Open Ports Distro"
  es_domain    = data.aws_ssm_parameter.es_domain.value
}

module "open_ports_table" {
  // two slashes are intentional: https://www.terraform.io/docs/modules/sources.html#modules-in-package-sub-directories
  source = "github.com/ministryofjustice/securityanalytics-analyticsplatform//infrastructure/kibana_saved_object"
  ...
  aws_region       = var.aws_region
  ssm_source_stage = var.ssm_source_stage
  object_template  = "${path.module}/visualisations/open_ports/open_ports_table.vis.json"
  ...
  object_type  = "visualization"
  object_title = "Open Ports Table"
  es_domain    = data.aws_ssm_parameter.es_domain.value
}


module "open_ports_cloud" {
  // two slashes are intentional: https://www.terraform.io/docs/modules/sources.html#modules-in-package-sub-directories
  source = "github.com/ministryofjustice/securityanalytics-analyticsplatform//infrastructure/kibana_saved_object"
  ...
  aws_region       = var.aws_region
  ssm_source_stage = var.ssm_source_stage
  object_template  = "${path.module}/visualisations/open_ports/open_ports_cloud.vis.json"
  ...
  object_type  = "visualization"
  object_title = "Open Ports Cloud"
  es_domain    = data.aws_ssm_parameter.es_domain.value
}


module "open_ports_filter" {
  // two slashes are intentional: https://www.terraform.io/docs/modules/sources.html#modules-in-package-sub-directories
  source = "github.com/ministryofjustice/securityanalytics-analyticsplatform//infrastructure/kibana_saved_object"
  ...
  aws_region       = var.aws_region
  ssm_source_stage = var.ssm_source_stage
  object_template  = "${path.module}/visualisations/open_ports/open_ports_filter.vis.json"
  ...
  object_type  = "visualization"
  object_title = "Open Ports Filter"
  es_domain    = data.aws_ssm_parameter.es_domain.value
}


module "open_ports_ai_table" {
  // two slashes are intentional: https://www.terraform.io/docs/modules/sources.html#modules-in-package-sub-directories
  source = "github.com/ministryofjustice/securityanalytics-analyticsplatform//infrastructure/kibana_saved_object"
  ...
  aws_region       = var.aws_region
  ssm_source_stage = var.ssm_source_stage
  object_template  = "${path.module}/visualisations/open_ports/open_ports_ai_table.vis.json"
